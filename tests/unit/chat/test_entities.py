...
class TestMessage:
    ...
    def test_message_creation_with_defaults(self):
        ...
        # Arrange & Act
        message = Message(content="Hello, world!", user_id="user-123")
...
class TestChatSession:
    ...
    def test_chat_session_creation_with_session_id(self):
        ...
        # Arrange & Act
        session = ChatSession(
            user_id="user-123", conversation_flow="general", session_id="session-456"
        )
    ...
    def test_multiple_threads_in_session(self):
        ...
        thread3 = session.get_or_create_thread(
            thread_id="thread-1"
...
class TestChatEntitiesIntegration:
    ...
    def test_complete_chat_flow(self):
        ...
        assert (
            thread.messages[1].content == "I'll be happy to help you with your account"
        )
    ...
    def test_session_with_multiple_threads_and_messages(self):
        ...
        thread2.add_message(
            Message(content="I have a technical issue", user_id="user-123")
        )
        thread2.add_message(
            Message(content="Let me help you with that", user_id="agent-789")
        )
