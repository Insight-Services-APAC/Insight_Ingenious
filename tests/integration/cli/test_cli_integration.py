...
class TestCLIIntegration:
    ...
    def test_create_project_command_invalid_name(
        ...
        # Act
        result = cli_runner.invoke(
            cli_app, ["create-project", invalid_name, str(project_path)]
        )
    ...
    def test_list_templates_command(self, cli_runner, cli_app):
        ...
        # Assert
        assert result.exit_code == 0
        assert "templates" in result.stdout.lower() or any(
    ...
    def test_generate_template_command(self, cli_runner, cli_app, temp_project_dir):
        ...
        with patch(
            ...
            # Act
            result = cli_runner.invoke(
                cli_app, ["generate-template", template_name, str(output_path)]
            )
    ...
    def test_project_info_command(self, cli_runner, cli_app, temp_project_dir):
        ...
        with patch(
            ...
            mock_instance.get_project_config.return_value = Mock(
                name="info-project", path=str(project_path), profile="dev"
            )
            mock_service.return_value = mock_instance

            # Act
            result = cli_runner.invoke(cli_app, ["project-info", str(project_path)])
    ...
    def test_command_with_invalid_options(self, cli_runner, cli_app):
        ...
        # Act
        result = cli_runner.invoke(
            cli_app, ["start-server", "--invalid-option", "value"]
        )
    ...
    def test_verbose_output(self, cli_runner, cli_app):
        ...
        with patch(
            ...
            # Act
            result = cli_runner.invoke(cli_app, ["server-status", "--verbose"])
            ...
            with patch(
                ...
                with patch(
                    ...
                    mock_project_instance.get_project_config.return_value = Mock(
                        name=project_name, path=str(project_path), profile="dev"
                    )
                    mock_project.return_value = mock_project_instance

                    mock_template_instance = Mock()
                    mock_template_instance.generate_template.return_value = True
                    mock_template_instance.list_templates.return_value = [
                        "basic",
                        "react",
                    ]
                    mock_template.return_value = mock_template_instance
                    ...
                    mock_server_instance.is_running.side_effect = [
                        False,
                        True,
                        True,
                        False,
                    ...
                    info_result = cli_runner.invoke(
                        cli_app, ["project-info", str(project_path)]
                    )
    ...
    def test_error_handling_workflow(self, cli_runner, cli_app, temp_workspace):
        ...
        with patch(
            ...
            with patch(
                ...
                mock_project_instance = Mock()
                mock_project_instance.project_exists.return_value = (
                    True  # Project already exists
                )
                mock_project.return_value = mock_project_instance

                mock_server_instance = Mock()
                mock_server_instance.is_running.return_value = (
                    True  # Server already running
                )
                mock_server.return_value = mock_server_instance
                ...
                mock_project_instance.get_project_config.side_effect = (
        ...
        with patch(
            ...
            with patch(
                ...
                result1 = cli_runner.invoke(
                    cli_app, ["create-project", "project1", str(project1)]
                )

                result2 = cli_runner.invoke(
                    cli_app, ["create-project", "project2", str(project2)]
                )
