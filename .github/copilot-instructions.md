...
- Follow the project's Domain-Driven Design (DDD), bounded contexts, and clean architecture conventions throughout.

## Note

- Do **not** use `pip` or `pip-tools` directly; use `uv` commands above.
- Mock Azure services are not yet implemented; examples use mock endpoints.
